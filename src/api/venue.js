(function(root){
  async function fetchVenueConfig(config, venueFilter = null) {
  ...
  async function fetchPricing(config, { venue, venueArea, date, guests, duration = 4 }) {
  ...
  root.GMVenueAPI = { fetchVenueConfig, fetchPricing };
